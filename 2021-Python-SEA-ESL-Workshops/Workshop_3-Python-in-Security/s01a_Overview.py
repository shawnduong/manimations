...
class s01a_Overview(Scene):
	...
	def construct(self):
		...
		objectives = [
			Text("1. Review a collection of Python concepts."),
			Text("2. Explore another application of Python."),
			Text("3. Gain more comfort writing basic Python code."),
		]

		agenda = [
			Text("- Overview of Workshop Activity"),
			Text("- Computer Networking Hosts and Ports"),
			Text("- Review: For Loops"),
			Text("- Review: Functions"),
			Text("- Activity: Creating a Port Scanner"),
		]
